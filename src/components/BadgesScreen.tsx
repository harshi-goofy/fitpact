  ...
  return (
    <div className="fp-screen">
      <header className="pt-3.5 pb-5">
        ...
        <h1 className="mt-1 text-[28px] font-bold tracking-[-.5px] text-text">Streaks & badges</h1>
      </header>
        ...
        {badges.map((b) => {
          ...
          return (
            ...
            >
              ...
              />
              <div>
                <div className="text-[15px] font-bold text-text">{b.name}</div>
                <div className="mt-0.5 text-[13px] font-medium leading-snug text-muted">
                  {b.description}
                </div>
              </div>
            </Card>
